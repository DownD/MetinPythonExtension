import net_packet,chat,OpenLog
...
CONFIG_MAP_NPCS = net_packet.PATH + 'OpenBot/Saves/NpcMaps/'
CONFIG_MAP_LINKS = net_packet.PATH + 'OpenBot/Saves/map_linker.txt'


CONFIG = net_packet.PATH + 'OpenBot/Saves/config.bot'
CONFIG_PRICE = net_packet.PATH + 'OpenBot/Saves/priceconfig.bot'
CONFIG_BOSSES_ID = net_packet.PATH + 'OpenBot/Saves/boss_ids.txt'
CONFIG_PSHOP_AUTO_BUY = net_packet.PATH + 'OpenBot/Saves/search_items_max_price.txt'
CONFIG_PICKUP_FILTER = net_packet.PATH + 'OpenBot/Saves/pickup_filter.txt'
CONFIG_SHOP_CREATOR = net_packet.PATH + 'OpenBot/Saves/item_sell_prices.txt'
CONFIG_SELL_INVENTORY = net_packet.PATH + 'OpenBot/Saves/items_to_sell.txt'
CONFIG_LOCATION_CHANGER = net_packet.PATH + 'OpenBot/Saves/location_changer.txt'
SHOP_CREATOR_LOG = net_packet.PATH + 'OpenBot/Saves/shop_log.txt'
