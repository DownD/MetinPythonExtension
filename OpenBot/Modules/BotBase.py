...
class BotBase(ui.ScriptWindow):
	...
	The Frame need to be redifined in the superclass, this is the method called repetedly and it's resposible for perfoming the bot actions 
	...
	The CanPause, Pause, Resume, StartBot and StopBot functions can be redifined in the superclass in order to perfmore specific actions.
