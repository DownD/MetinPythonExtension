...
class OpenBotHackbarDialog(ui.ScriptWindow): 				
	...
	def __init__(self):
		...
		self.GoForward = self.comp.HideButton(None, '', '', wndMgr.GetScreenWidth()-230, -2, lambda : self.TeleportInDirection(1), 'OpenBot/Images/Shortcuts/Arrow/tele_up_0.tga', 'OpenBot/Images/Shortcuts/Arrow/tele_up_1.tga', 'OpenBot/Images/Shortcuts/Arrow/tele_up_0.tga')
		...
		#self.CopyrightLabel = self.comp.TextLine(self.OpenBotBoard, '(c)123klo', 7, 540, self.comp.RGB(255, 255, 0))
	...
	def TeleportInDirection(self, direction):
		...
		net_packet.SendStatePacket(trueX,trueY,0,net_packet.CHAR_STATE_STOP,0)
