...
class BuffDialog(ui.ScriptWindow):
	...
	def __init__(self):
		...
		self.BuffOff = self.comp.HideButton(self.Board, '', '', 84, 180, self.SetBuffStatus, 'm2kmod/Images/start_0.tga', 'm2kmod/Images/start_1.tga', 'm2kmod/Images/start_2.tga')
		self.BuffOn = self.comp.HideButton(self.Board, '', '', 84, 180, self.SetBuffStatus, 'm2kmod/Images/stop_0.tga', 'm2kmod/Images/stop_1.tga', 'm2kmod/Images/stop_2.tga')
		self.SegenOn = self.comp.HideButton(self.Board, '', '', 55, 80, self.BuffSegen, 'm2kmod/Images/on_0.tga', 'm2kmod/Images/on_1.tga', 'm2kmod/mages/on_2.tga')
		self.SegenOff = self.comp.HideButton(self.Board, '', '', 55, 80, self.BuffSegen, 'm2kmod/Images/off_0.tga', 'm2kmod/Images/off_1.tga', 'm2kmod/Images/off_2.tga')
		self.HDDOn = self.comp.HideButton(self.Board, '', '', 100, 80, self.BuffHDD, 'm2kmod/Images/on_0.tga', 'm2kmod/Images/on_1.tga', 'm2kmod/mages/on_2.tga')
		self.HDDOff = self.comp.HideButton(self.Board, '', '', 100, 80, self.BuffHDD, 'm2kmod/Images/off_0.tga', 'm2kmod/Images/off_1.tga', 'm2kmod/Images/off_2.tga')
		self.ReflektOn = self.comp.HideButton(self.Board, '', '', 147, 80, self.BuffReflekt, 'm2kmod/Images/on_0.tga', 'm2kmod/Images/on_1.tga', 'm2kmod/mages/on_2.tga')
		self.ReflektOff = self.comp.HideButton(self.Board, '', '', 147, 80, self.BuffReflekt, 'm2kmod/Images/off_0.tga', 'm2kmod/Images/off_1.tga', 'm2kmod/Images/off_2.tga')
	...
	def Update(self):
		if self.BuffStatus:
			...
			self.Name.SetText(chr.GetNameByVID(self.TargetVID))
		self.UpdateBuff = m2k_lib.WaitingDialog()
	...
	def FollowTarget_1(self):
		...
		self.UpdateFollow = m2k_lib.WaitingDialog()
