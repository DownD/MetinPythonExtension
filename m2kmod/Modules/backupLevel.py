...
class LevelbotDialog(ui.ScriptWindow): 				
	...
	#	self.Board.AddFlag("float") 
		...
		self.MonsterButton = self.comp.OnOffButton(self.Board, '', 'Attack monsters', 135, 280,image="m2kmod/Images/General/boss.tga")#"m2kmod/Images/General/monster.tga")
	...
	def LoadSettings(self):
		self.RedPercent = int(FileManager.ReadConfig("RedPercent"))
		self.BluePercent = int(FileManager.ReadConfig("BluePercent"))
		self.TapfiSec = int(FileManager.ReadConfig("TapfiSec"))
		self.Horse = int(FileManager.ReadConfig("Horse"))
		self.Pick = int(FileManager.ReadConfig("Pickup"))
		self.Rotation = int(FileManager.ReadConfig("Rotation"))
		self.ExpDonator = int(FileManager.ReadConfig("ExpDonator"))
		self.AutoPotion = int(FileManager.ReadConfig("AutoPotion"))
		self.RedPotID = int(FileManager.ReadConfig("Red-Pot"))
		self.BluePotID = int(FileManager.ReadConfig("Blue-Pot"))
		self.RedAutoPotID = int(FileManager.ReadConfig("AutoRed-Pot"))
		self.BlueAutoPotID = int(FileManager.ReadConfig("AutoBlue-Pot"))
		self.CapeId = int(FileManager.ReadConfig("Bravery-Cape"))
		self.PullButton.SetValue(int(FileManager.ReadConfig("Pull")))
		self.MetinButton.SetValue(int(FileManager.ReadConfig("Attack-Metin")))
		self.BossButton.SetValue(int(FileManager.ReadConfig("Attack-Boss")))
		self.MonsterButton.SetValue(int(FileManager.ReadConfig("Attack-Monster")))
		self.TimeWaitMetinDead.SetText(FileManager.ReadConfig("TimeMetinDead"))

	def Hide_UI(self):
		FileManager.WriteConfig("RedPercent", str(self.RedPercent))
		FileManager.WriteConfig("BluePercent", str(self.BluePercent))
		FileManager.WriteConfig("TapfiSec", str(self.TapfiSec))
		FileManager.WriteConfig("Horse", str(self.Horse))
		FileManager.WriteConfig("Pickup", str(self.Pick))
		FileManager.WriteConfig("Rotation", str(self.Rotation))
		FileManager.WriteConfig("ExpDonator", str(self.ExpDonator))
		FileManager.WriteConfig("AutoPotion", str(self.AutoPotion))
		FileManager.WriteConfig("Pull", str(self.PullButton.isOn))
		FileManager.WriteConfig("Attack-Metin", str(self.MetinButton.isOn))
		FileManager.WriteConfig("Attack-Boss", str(self.BossButton.isOn))
		FileManager.WriteConfig("Attack-Monster", str(self.MonsterButton.isOn))
		FileManager.WriteConfig("TimeMetinDead", str(self.TimeWaitMetinDead.GetText()))
	#	FileManager.WriteConfig("Red-Pot", str(self.RedPotID))
	#	FileManager.WriteConfig("Blue-Pot", str(self.BluePotID))
	#	FileManager.WriteConfig("AutoRed-Pot", str(self.RedAutoPotID))
	#	FileManager.WriteConfig("AutoBlue-Pot", str(self.BlueAutoPotID))
	#	FileManager.WriteConfig("Bravery-Cape", str(self.CapeId))
		FileManager.Save()
		self.Board.Hide()	
...
#
	...
	#		read = FileManager.ReadConfig("Skill"+str(i+1))
	#		split = read.split(",")
	#		ActiveSkillData = { 
	#			"COUNT":int(split[2]),
	#			"INDEX":int(split[1]),
	...
	#	}
	#	if Search == 0:
	#		#FileManager.WriteConfig("Skill"+str(SkillEvent), "1," + str(SkillIndex) + "," + str(SkillEvent))
	#		self.ActiveSkillList.append(ActiveSkillData)
	...
	#	else:
	#		#FileManager.WriteConfig("Skill"+str(SkillEvent), "0," + str(SkillIndex) + "," + str(SkillEvent))
	#		self.ActiveSkillList.remove(ActiveSkillData)
